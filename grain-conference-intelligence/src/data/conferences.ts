...
export const CONFERENCES: ConferenceRecord[] = [
  ...
  defineConference({
    ...
    claims: {
      ...
      buyer_role_density: { claim: "The 2026 ticket page reports 38,000+ attendees and describes connecting with fintech leaders, investors, and innovators.", sourceUrl: "https://money2020middleeast.com/tickets-2026" },
  ...
  defineConference({
    ...
    claims: {
      vertical_fit: { claim: "The official 2027 page positions the event as a B2B and AI gathering of founders, executives, and VCs.", sourceUrl: "https://www.saastrannual.com/" },
      buyer_role_density: { claim: "The official 2027 page reports 10,000+ attendees, including founders, CROs, CMOs, CCOs, and venture capitalists.", sourceUrl: "https://www.saastrannual.com/" },
      fx_relevance: { claim: "The reviewed organizer page does not assert a dedicated FX or cross-border treasury programme.", sourceUrl: "https://www.saastrannual.com/", tag: "unknown" },
      meeting_accessibility: { claim: "The official 2027 page advertises 3,000+ scheduled one-to-one meetings through its matchmaking app.", sourceUrl: "https://www.saastrannual.com/" },
      trip_efficiency: unknownTrip("the San Francisco Bay Area", "https://www.saastrannual.com/"),
    },
  }),
  defineConference({
